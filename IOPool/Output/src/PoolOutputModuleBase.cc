...
namespace edm {
  ...
  PoolOutputModuleBase::AuxItem::AuxItem() : basketSize_(BranchDescription::invalidBasketSize) {}
  ...
  PoolOutputModuleBase::OutputItem::OutputItem(BranchDescription const* bd,
                                               EDGetToken const& token,
                                               int splitLevel,
                                               int basketSize)
      : branchDescription_(bd), token_(token), splitLevel_(splitLevel), basketSize_(basketSize) {}
  ...
  bool PoolOutputModuleBase::OutputItem::Sorter::operator()(OutputItem const& lh, OutputItem const& rh) const {
  ...
  void PoolOutputModuleBase::fillSelectedItemList(BranchType branchType,
                                                  TTree* theInputTree,
                                                  SelectedProductsForBranchType const& keptProducts) {
  ...
  void PoolOutputModuleBase::respondToOpenInputFileBase(FileBlock const& fb,
                                                        SelectedProductsForBranchType const& keptProducts) {
  ...
  void PoolOutputModuleBase::writeFileFormatVersion(RootOutputFile* rootOutputFile) {
    rootOutputFile->writeFileFormatVersion();
  }
  void PoolOutputModuleBase::writeFileIdentifier(RootOutputFile* rootOutputFile) {
    rootOutputFile->writeFileIdentifier();
  }
  void PoolOutputModuleBase::writeIndexIntoFile(RootOutputFile* rootOutputFile) {
    rootOutputFile->writeIndexIntoFile();
  }
  void PoolOutputModuleBase::writeStoredMergeableRunProductMetadata(RootOutputFile* rootOutputFile) {
    rootOutputFile->writeStoredMergeableRunProductMetadata();
  }
  void PoolOutputModuleBase::writeProcessHistoryRegistry(RootOutputFile* rootOutputFile) {
    rootOutputFile->writeProcessHistoryRegistry();
  }
  void PoolOutputModuleBase::writeParameterSetRegistry(RootOutputFile* rootOutputFile) {
    rootOutputFile->writeParameterSetRegistry();
  }
  void PoolOutputModuleBase::writeProductDescriptionRegistry(RootOutputFile* rootOutputFile) {
    rootOutputFile->writeProductDescriptionRegistry();
  }
  void PoolOutputModuleBase::writeParentageRegistry(RootOutputFile* rootOutputFile) {
    rootOutputFile->writeParentageRegistry();
  }
  void PoolOutputModuleBase::writeBranchIDListRegistry(RootOutputFile* rootOutputFile) {
    rootOutputFile->writeBranchIDListRegistry();
  }
  void PoolOutputModuleBase::writeThinnedAssociationsHelper(RootOutputFile* rootOutputFile) {
    rootOutputFile->writeThinnedAssociationsHelper();
  }
  void PoolOutputModuleBase::writeProductDependencies(RootOutputFile* rootOutputFile) {
    rootOutputFile->writeProductDependencies();
  }
  void PoolOutputModuleBase::finishEndFile(RootOutputFile* rootOutputFile, bool doWrite) {
    rootOutputFile->finishEndFile(doWrite);
  }
  void PoolOutputModuleBase::doExtrasAfterCloseFile() {}

  std::pair<std::string, std::string> PoolOutputModuleBase::physicalAndLogicalNameForNewFile() {
  ...
  void PoolOutputModuleBase::updateBranchParentsForOneBranch(ProductProvenanceRetriever const* provRetriever,
  ...
  void PoolOutputModuleBase::updateBranchParents(EventForOutput const& e, SubProcessParentageHelper const* helper) {
  ...
  void PoolOutputModuleBase::preActionBeforeRunEventAsyncBase(WaitingTask* iTask,
  ...
  void PoolOutputModuleBase::fillDependencyGraph() {
  ...
  void PoolOutputModuleBase::fillDescription(ParameterSetDescription& desc) {
    ...
    desc.addUntracked<int>("compressionLevel", 7)->setComment("ROOT compression level of output file.");
    ...
    desc.addUntracked<int>("eventAutoFlushCompressedSize", -1)
        ->setComment(

...
namespace edm {
  ...
  public:
    ...
    TFileCacheRead* GetCacheRead(const TObject* tree) const { return file_->GetCacheRead(tree); }
    void SetCacheRead(TFileCacheRead* tfcr, TObject* tree) { file_->SetCacheRead(tfcr, tree, TFile::kDoNotDisconnect); }

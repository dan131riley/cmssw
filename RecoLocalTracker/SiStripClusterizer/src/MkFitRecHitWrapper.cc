...
MkFitRecHitWrapper::MkFitRecHitWrapper(std::vector<mkfit::HitVec> hits, int totalHits, std::vector<std::vector<float>> barycenters, std::vector<std::vector<int>> detIds)

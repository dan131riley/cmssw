...
//using ROOT::Experimental::RNTupleFieldPtr;
...
public:
  ...
  TriggerFieldPtr(std::string name, int index, RNTupleFieldPtr<bool> field);
...
public:
  ...
  void fill(const edm::EventForOutput& event, RNTupleWriter& writer);
...
private:
  ...
  void updateTriggerFields(const edm::TriggerResults& triggerResults, RNTupleWriter& writer);
